...
import static newcloud.ExceuteData.LearningScheduleTest.brokerId;
 ...
 */
public class PowerDatacenterLearning extends PowerDatacenter {
    ...
    private VmAllocationAssignerLearning vmAllocationAssignerLearning;
    ...
    public PowerDatacenterLearning(
            ...
            VmAllocationAssignerLearning vmAllocationAssignerLearning) throws Exception {
        ...
        setMigrationCount(0);
        this.vmAllocationAssignerLearning = vmAllocationAssignerLearning;
        resetEnvironment();
    }
    ...
    protected void processVmCreate(SimEvent ev, boolean ack) {
        Vm vm = (Vm) ev.getData();
        int hostid = vmAllocationAssignerLearning.createAction(currentcpu);
