 ...
 */
public class PowerDatacenterFair extends PowerDatacenter {
    ...
    private VmAllocationAssignerFair vmAllocationAssignerFair;
    ...
    public PowerDatacenterFair(
            ...
            double schedulingInterval, VmAllocationAssignerFair vmAllocationAssignerFair) throws Exception {
        ...
        setMigrationCount(0);
        this.vmAllocationAssignerFair = vmAllocationAssignerFair;
    }
    ...
    protected void processVmCreate(SimEvent ev, boolean ack) {
        Vm vm = (Vm) ev.getData();
        targetHost = vmAllocationAssignerFair.getVmAllcaotionHost(getHostList());
